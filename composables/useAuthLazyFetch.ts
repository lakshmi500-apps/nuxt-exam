...
export const useAuthLazyFetch = (request: any, options: any | undefined | null) => {
    ...
    return useLazyFetch(request, {
        ...
        onRequest({ request, options }) {
            ...
            options.headers = {
                Authorization: `BearereyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1IjoiOGNmYTQ3MGM5ZmYyNGUyZjk4OTQxOGQ1MWJjYmFlOTkiLCJkIjoiMTY4MDA5OCIsInIiOiJzYSIsInAiOiJmcmVlIiwiYSI6ImZpbmRlci5pbyIsImwiOiJ1czEiLCJleHAiOjE2ODMyOTA5MDJ9.RCYZfrnk9QnGZoRnAZf6pWjnnABhBdC6enxT7smdiFw`,
            }   
        },
